...
export default function AddAppPic({ fetchData }) {
  ...
  return (
    <>
      <div className="bg-white-100 pt-1 sm:p-1 p-3 rounded-xl dark:bg-black-200 dark:text-white-100 2xl:h-[31rem] h-[27rem] lg:my-5 sm:my-5 lg:mb-0 mb-5 sm:col-span-2 col-span-3">
        {showAddAppPic && (
          <AddAppPicData
