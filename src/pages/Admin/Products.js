...
export default function Products() {
  ...
  return (
    <section className="p-6 float-right mt-12 bg-white-200 dark:bg-black-600 lg:w-[87%] w-[93%]">
      <div className="grid grid-cols-10">
        ...
        <div className="relative lg:col-span-3 col-span-10 mt-5 mx-4">
          ...
          <div className="mb-4 dark:bg-black-200 bg-white-100 rounded-xl">
            <Departments />
          </div>
        </div>
      </div>
