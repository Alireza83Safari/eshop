...
const Footer = () => {
  return (
    <footer className="bg-white-300 dark:bg-black-900 text-black-900 dark:text-white-100">
      <div className="container mx-auto py-8 px-4">
        ...
        <div className='footer-section '>   
              ...
              <form className="mt-2">
                ...
                <button
                  type="submit"
                  className="mt-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:bg-blue-700"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="footer-section">
            ...
            <p className='text-sm w-72'>
              Insert a brief description of your website or company here.
              You can also include your mission statement or values.
            </p>
          </div>
          <div className="footer-section">
            ...
            <ul className='text-gray-300 hover:text-white text-sm'>
              ...
              <li><a href="#" className="text-gray-300 w-20 hover:text-white">Services</a></li>
